...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Verify Email - PennyTree</title>
        ...
        <div class="col-lg-6">
          <div class="row">
            ...
            <div class="col-md-4 my-30">
              <h4>Products</h4>
              <ul>
                <li><a href="penn-rules">Penn Rules</a></li>
                <li><a href="payment">Payment</a></li>
                <li><a href="wallet-transfer">Wallet Transfer</a></li>
                <li><a href="target-savings">Target Savings</a></li>
                <li><a href="personal-vaults">Personal Vaults</a></li>
              </ul>
            </div>
            <div class="col-md-4 my-30">
              <h4>Contact Us</h4>
    ...
    <script>
      ...
      $.ajax({
        ...
        success: function (data) {
          if (data == "Email successfully verified.") {
