    ...
    <div class="about-us">
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="vision">
            <h4><span class="thin">Our Vision</span></h4>
            <h2>To make humanity seamless through finance.</h2>
          </div>

          <div class="vision">
            <h4><span class="thin">Our Mission</span></h4>
            <h2>
              We are integrating finance and lifestyle as a one-component.
            </h2>
          </div>
        </div>
        <div class="col-lg-6 align-self-center">
          <div class="about-img jump">
        ...
        <div class="col-lg-6 align-self-center order-lg-2 order-1">
          <div class="title">
            <h3><span class="thin">About</span> PennyTree</h3>
          </div>
          <p>
            PennyTree is a Lifestyle payment and savings application that helps
            you keep up with your savings habit and make payments. We are
            currently at a level where savings and wealth building are
            characterized by setting debit reminders and locking funds away in
            digital vaults. We thought we could even make this more seamless,
            fun and enjoyable by building an affinitive ecosystem; creating a
            clan of financially savvy customers who would automate wealth as
            they build their lifestyle. We make financial discipline fun,
            enjoyable and easy.
          </p>
        </div>
      </div>
